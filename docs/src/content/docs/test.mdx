...
<Details summary="What to expect">![](/qbittorrent-nox-static/docs_images/script_usage/1.png)</Details>

<Details summary="What to expect"><Lightbox width="200" height="" path="/qbittorrent-nox-static/docs_images/script_usage/1.png"/></Details>
